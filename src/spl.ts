...
export const getBurnTxAndSigner = async (
  ...
  const txs: Transaction[] = await getSPLBurnTxs(
    connection,
    payer,
    source,
    mint,
...
// ==========================================================================
// - MARK: change authority
// ==========================================================================

/**
 * Disable MintToken Authority, So the SPL token get a fixed supply
 *
 * @param connection
 * @param payer
 ...
 * @param account
 */
export const disableMintTokenAuthority = async (
  connection: Connection,
  payer: Keypair,
  ...
  console.log(`SPL MintToken disable: signature=${encodeTx.encodedSignature}`);
  return encodeTx;
};
